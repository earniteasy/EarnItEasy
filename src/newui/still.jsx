        ...
        <section id='hero' className="relative">
            <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-center px-6 lg:px-12 py-4 lg:py-16">
                ...
                <div className="text-center lg:text-center">
                    ...
                    <div>
                    <a href="https://github.com/earniteasy/EarnItEasy/raw/refs/heads/main/src/download/release.apk" download className="bg-black text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:bg-gray-700 transition duration-300">Android App</a>
                    </div>
                    <div className='bg-gray-300 w-[1px] rounded m-4'></div>
                    <div>
                    <a href="#ios" className="bg-gray-200 text-black font-semibold px-6 py-3 rounded-full hover:bg-gray-300 transition duration-300">IOS App</a>
                    </div>
                    </div>
